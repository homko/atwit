...
describe User, type: :model do
  before do
     @user = User.new(name: 'Yohan', email: 'yohan@gmail.com',
  ...
  describe 'downcase email' do
    let(:up_case_email) { 'SIMPLE@EMAIL.COM' }
    before do
    ...
    it { should eq(up_case_email.downcase) }
  end
  ...
  describe 'return value of authoritative method' do
    before { @user.save }
